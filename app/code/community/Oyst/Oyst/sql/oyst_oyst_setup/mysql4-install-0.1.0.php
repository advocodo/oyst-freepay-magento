...
$table = $installer->getConnection()
    ...
    ->addColumn('notification_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array('identity' => true, 'unsigned' => true, 'nullable' => false, 'primary' => true), 'Unique identifier')
    ...
    ->addForeignKey($installer->getFkName('oyst_oyst/notification', 'order_id', 'sales/order', 'entity_id'), 'order_id', $installer->getTable('sales/order'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE);
